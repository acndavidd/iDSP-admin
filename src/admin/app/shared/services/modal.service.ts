...
export module Modal {
    ...
    export class ModalService {
        ...
        setModalType(pModalType: number) {
            ...
            this.vDefaultOKButton = new ModalButton('ok-button', 'green', 'OK', vCallBackStack, null);
            this.vDefaultCANCELButton  = new ModalButton('cancel-button', 'green', 'CANCEL', vCallBackStack, null);
