...
@Component({
    selector: 'retailer-share',
    templateUrl: './app/retailers/components/retailer-share.component.html',
...
export class RetailerShareComponent {
    private vDate: Date;
    ...
    constructor(
        ...
        this._layoutService.setCurrentPage('RetailerShare');
